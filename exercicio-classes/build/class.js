...
class LeagueNBA {
    ...
    constructor(club, players, city, avaliable, //Pode ser acessada somente pela própria classe.
    wage) {
        this.club = club;
...
class Color extends LeagueNBA {
    constructor(colorsShirt, club, players, city, avaliable, wage) {
        super(club, players, city, avaliable, wage);
        this.colorsShirt = colorsShirt;
        this.colorsShirt = colorsShirt; //ao utilizar protected, podemos acessar por classes
    }
    retornaDados2() {
        //Função para poder acessar os dados 'Private' e 'Protected'
